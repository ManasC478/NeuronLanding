...
import ArjunImage from "../public/Arjun.png";
...
const Team = () => {
  const teamMembers = [
    ...
    {
      image_url: ArjunImage,
      name: "Arjun Krishnan",
      position: "Designer",
      linkedIn: "",
      github: "https://github.com/AKris0090",
    },
  ];
  ...
  return (
    <section className='team' id='team'>
      ...
      <p>
        Meet our dedicated and commited team. We strive to simplify the process
